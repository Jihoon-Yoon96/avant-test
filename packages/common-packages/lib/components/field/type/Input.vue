...
<!--            </Field>-->
            ...
            <div>
                ...
                <div>
                    ...
                    <template v-if="field_type==='String'">
                        <CommonField>
                    ...
                    <template v-if="field_type==='Number'">
                        <CommonField >
...
let field_type_option = ref([{value: 'String', label: 'String'}, {value: 'Number', label: 'Number'}])
